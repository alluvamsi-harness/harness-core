...
import static io.harness.beans.FeatureName.EXECUTION_ID_BASED_TF_BASE_DIR;
...
public class TerraformRollbackStateTest extends WingsBaseTest {
  ...
  public void testExecuteInternalAwsCPAuthEnabled() {
    ...
    doReturn(true).when(featureFlagService).isEnabled(eq(EXECUTION_ID_BASED_TF_BASE_DIR), any());
    ...
    assertThat(parameters.isUseExecutionIdBasedTfBaseDir()).isTrue();
    assertThat(parameters.getWorkflowExecutionId()).isEqualTo(WORKFLOW_EXECUTION_ID);
  }
